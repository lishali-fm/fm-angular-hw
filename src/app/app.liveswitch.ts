...
@Component({
  selector: 'app-root',
  templateUrl: './app.liveswitch.html',
  styleUrls: ['./app.liveswitch.css']
})

export class LiveSwitchComp {
  // 1. Make sure you supply your company values in the Config. 
  // *NOTE* THIS EXAMPLE WILL NOT WORK WITHOUT FILLING IN THE CONFIG!
  ...
  public async run() {
    ...
    // 0. Setup develoepr logging for the app to console.
    fmLiveswitch.Log.registerProvider(new fmLiveswitch.ConsoleLogProvider(fmLiveswitch.LogLevel.Debug));

    // 0a. Setup the layout manager to handle our layouts for us. 
    ...
    // A super easy way to adjust the layout. This is my favorite. 
    ...
    try {
      ...
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.localmedia.html#constructors-1
    ...
    {
      // Logs to console.
      //fmLiveswitch.Log.error("Error starting local media.", localMediaException);
      // Logs to display.
    ...
    try {
      ...
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.client.html?q=client
      ...
      // *NOTE* ChannelClaim objects have a bunch of security permissions you can set for the user. 
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.channelclaim.html
      let primaryChannel = new fmLiveswitch.ChannelClaim("ChannelId");
      ...
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.token.html
      ...
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.client.html
      ...
      // Logs to console.
      //fmLiveswitch.Log.error("Error registering client.", clientException);
      // Logs to display.
    ...
    let openDownstreamConnection = async (remoteConnectionInfo: fmLiveswitch.ConnectionInfo, channel: fmLiveswitch.Channel) : Promise<fmLiveswitch.SfuDownstreamConnection | null> => {
      ...
      // *NOTE* if you are connecting to a broadcast you would use the Media Id instead of the remoteConnectionInfo. 
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.channel.html
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.sfudownstreamconnection.html
    ...
    let openUpstreamConnection = async (localMedia: fmLiveswitch.LocalMedia, channel: fmLiveswitch.Channel) : Promise<fmLiveswitch.SfuUpstreamConnection | null> =>
    {
      ...
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.channel.html
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.sfuupstreamconnection.html
      // https://developer.liveswitch.io/reference/ts/api/classes/fm.liveswitch.managedconnection.html
      // *NOTE* You could also specify a Media ID if you are broadcasting this upstream.
      // https://help.frozenmountain.com/docs/liveswitch-cloud/faq/does-liveswitch-cloud-support-broadcasting
